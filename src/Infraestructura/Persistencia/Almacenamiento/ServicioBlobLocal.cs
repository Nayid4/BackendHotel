...
namespace Infraestructura.Persistencia.Almacenamiento
{
    public class ServicioBlobLocal : IServicioBlob
    {
        ...
        public ServicioBlobLocal(string rutaBase)
        {
        ...
        public async Task<ErrorOr<Guid>> SubirArchivoAsync(Stream stream, string nombreArchivo, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<ErrorOr<RespuestaDeArchivo>> DescargarArchivoAsync(Guid idArchivo, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                return new RespuestaDeArchivo(stream, contentType);
            }
        ...
        public Task<ErrorOr<Unit>> EliminarArchivoAsync(Guid idArchivo, CancellationToken cancellationToken = default)
        {
            try
            {
                var archivos = Directory.GetFiles(_rutaBase, $"{idArchivo}.*");
